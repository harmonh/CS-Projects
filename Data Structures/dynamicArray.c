...
/* Name: Holly Harmon	
 * Date: 04/20/2014
 * Solution description: Implementation file for functions used to create/initiate/change dynamic arrays with
 * stack and bag interfaces.
 */
...
void pushDynArr(DynArr *v, TYPE val)
{
	...
	if (v->size == v->capacity)
	{
		//call resize first to increase capacity
		_dynArrSetCapacity(v, v->capacity + 10);
	}
